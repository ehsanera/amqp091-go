...
func ExampleChannel_Confirm_bridge() {
	...
	if err := chs.ExchangeDeclare("log", amqp.ExchangeTopic, true, false, false, false, nil); err != nil {
	...
	if err := chd.ExchangeDeclare("log", amqp.ExchangeTopic, true, false, false, false, nil); err != nil {
		log.Fatalf("exchange.declare destination: %s", err)
	}
...
func ExampleChannel_Consume() {
	...
	err = c.ExchangeDeclare("logs", amqp.ExchangeTopic, true, false, false, false, nil)
	if err != nil {
